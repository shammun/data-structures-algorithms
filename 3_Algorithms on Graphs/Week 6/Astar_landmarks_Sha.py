...
def bidirectional_astar(graph, start, goal, landmarks):
    ...
    backward_path, backward_cost = astar(graph, start, goal, landmarks, False)
    if backward_path:
        return backward_path, backward_cost
...
Shortest path: [(0, 0), (1, 1), (2, 2), (3, 1), (5, 0)]        
